...
<div class="owl-carousel banner-slider">
        <div class="item banner--demo slider-1">
            <div class="overlay">
        ...
        <div class="item banner--demo2 slider-2">
            <div class="overlay">
                <div class="container text-center text-white">
                    <h1 class="title mb-30">Hunger is stalking the globe</h1>
                    <p class="description mb-40">Hundreds of thousands of children experiencing or witnessing assault <br> and other gender-based violence.</p>
        ...
        <div class="item banner--demo3 slider-2">
            <div class="overlay">
                <div class="container text-center text-white">
                <h1 class="title mb-30">Hunger is stalking the globe</h1>
                    <p class="description mb-40">Hundreds of thousands of children experiencing or witnessing assault <br> and other gender-based violence.</p>
        ...
        <div class="col-md-12 col-lg-6">
            <div class="row">
                <div class="col-md-12 mb-30">
                    <picture>
                        <img class="rounded" width="560" height="250" loading="lazy" src="./images/common/archive-img-1.webp" alt="" srcset="">
                    </picture>
                </div>
                <div class="col-md-6 col-sm-6">
                    <picture>
                        <img class="rounded" width="270" height="260" src="./images/common/archive-img-2.webp" alt="" srcset="">
                    </picture>
                </div>
                <div class="col-md-6 col-sm-6 gx-5">
                    <picture>
                        <img class="rounded" width="270" height="260" src="./images/common/archive-img-3.webp" alt="" srcset="">
                    </picture>
                </div>
            </div>
        </div>
